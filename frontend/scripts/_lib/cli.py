"""scripts/_lib/cli.py — shared scaffolding for the `orwell-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("orwell-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/orwell-foo`
...
VERSION = "0.1.0"  # bumped centrally; every orwell-* CLI reports this
