...
COPILOT_USER_AGENT = os.environ.get(
    "ORWELL_COPILOT_USER_AGENT", "Orwell/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "ORWELL_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "ORWELL_COPILOT_EDITOR_VERSION", "Orwell/1.0"
)
