...
# Override at deploy time via `ORWELL_FALLBACK_OWNER` env var. In a real
# multi-user install set `ORWELL_SINGLE_USER=0` so unauthenticated requests
# are rejected instead of silently writing to this address.
import os as _os
FALLBACK_OWNER = _os.environ.get("ORWELL_FALLBACK_OWNER", "owner@localhost")
_SINGLE_USER_MODE = _os.environ.get("ORWELL_SINGLE_USER", "1") != "0"
