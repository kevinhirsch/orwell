...
def rank_models(system, use_case=None, limit=50, search=None, sort="score", quant=None, target_context=None, fit_only=False):
    ...
    for m in models:
        ...
        # MLX needs the mlx_lm runtime, which Orwell does not generate serve
        ...
        # otherwise prefer GGUF/Q* entries that Orwell can route through
        ...
        #
        # Windows is the same: Orwell only supports llama.cpp on Windows,
