...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('orwell-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'orwell-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'orwell-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'orwell-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'orwell-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'orwell-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'orwell-notes-first-open-hint-v1';
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('orwell-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'orwell-note-draft-';
