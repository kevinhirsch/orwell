...
const _SETTINGS_KEY = 'orwell-research-settings';
const _COLLAPSE_KEY = 'orwell-research-settings-collapsed';
  ...
  return `
    ...
    <div class="modal-body research-pane-body" data-no-swipe-dismiss>
      <div class="research-new-job">
        ...
        <textarea id="research-query" class="research-query" placeholder="e.g. Trace Orwell's ten-year journey home from Troy — every island, monster, and detour, and why each one cost him" rows="4"></textarea>
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('orwell-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
