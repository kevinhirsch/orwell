...
> [IMPORTANT] The View menu doesn’t include items for navigating between or managing specific windows; the the-menu-bar#Window-menu provides these commands.
...
> [IMPORTANT] The Window menu doesn’t help people customize the appearance of windows or close them. To customize a window, people use commands in the the-menu-bar#View-menu; to close a window, people choose Close in the the-menu-bar#File-menu.
