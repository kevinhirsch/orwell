...
| C2 | **OOBE authoring UI** in odysseus | OpenHands | A2, B6 |
...
### C2 — OOBE authoring UI in odysseus  ·  OpenHands

> In `kevinhirsch/bbai` `frontend/`, add the **character-creation (OOBE) flow** to the odysseus UI:
