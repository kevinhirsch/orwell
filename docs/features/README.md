...
| 0077 | [House map, privacy & eyeshot](./0077-house-map-privacy-and-eyeshot.md) | spec-only | 📝 Spec · a recent-BB floor plan + splits the overloaded adjacency relation into movement / sightline (eyeshot) / earshot graphs; occupancy becomes tracked knowledge with a pathway (can go stale); big rooms get sub-zones; "two alone too long" surfaces as a Vault-safe conspicuousness read. Sibling of 0076. Design note + `.feature`; not yet wired into `cucumber.cjs`. |
