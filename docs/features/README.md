...
| 0075 | [Trust-gated confidences](./0075-trust-gated-confidences.md) | spec-only | 📝 Spec · a houseguest confides a real secret only when they have a *reason* (bond/favor/debt), with a graduated disclosure ladder; both player-driven and emergent (never a cold pop-up); houseguests can plant false confidences. Vault Wall held structurally. Design note + `.feature`; not yet wired into `cucumber.cjs`. |
