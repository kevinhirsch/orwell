...
| **POLISH / VERIFY — real-LLM tail** | R2-01, R5-02, R7-01 | R2-01 non-binding comp-round chip-deselect disables Confirm (polish); **R5-02 (VERIFY)** — on the KEEP path the new cast must carry **zero** prior-season knowledge of the player (owner ruling; needs a deterministic callTool check); R7-01 the season-2 casting probe couldn't drive the casting-screen send affordance (harness gap, not confirmed product). |
