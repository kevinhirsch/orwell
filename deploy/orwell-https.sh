...
gen_caddyfile() {
  printf '%s\n' \
    ...
    "# WebSockets (GET /api/ws/session, WS Phase-1 / ADR 0017): Caddy's reverse-proxy passes the" \
    "# Upgrade/Connection handshake transparently — no extra directive needed. See deploy/expose/README.md."
