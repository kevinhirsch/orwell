...
export interface GameEvent {
  ...
  hidden: boolean;
  content: string;
  /** Content before any hidden-element / player-subject / scheme-target enrichment. Used by getOffscreenSceneSkeletons to return only the Vault-free public projection. */
  baseContent?: string;
  /**
