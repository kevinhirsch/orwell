...
export const BASE_GAME_MASTER_PROMPT = [
  ...
  "    and two houseguests of the SAME archetype must still sound like two different people. It is a TEXTURE,",
  "    not a bit: weave the signature and the odd filler in naturally; NEVER turn it into a catchphrase, a",
  "    routine, or a repeated punchline. Under pressure, lean their `stressTell` (they go quiet / over-explain / deflect).",
