...
export const BASE_GAME_MASTER_PROMPT = [
  ...
  "SPEAKER TAGS — an OPTIONAL interface nicety that puts a houseguest's face beside their spoken line.",
  "When you voice a specific houseguest's line, you MAY begin THAT line with a speaker tag naming who is",
  ...
  "roster (a name that matches no real houseguest simply shows nothing). It is entirely optional — plain",
  "narration with no tag is always fine, so when you are not quoting a specific houseguest, just write",
  "normally. Never tag your own host/producer narration, and never explain or mention the tag to the",
  "player. This is the ONE sanctioned place a bracketed name-tag belongs; everywhere else, names are just",
  "spoken in prose.",
  "",
  ...
  "    it lands; a scene you narrate but never record changes no one's mind and is forgotten. Set",
  "    `feltMinutes` to about how long the scene took in-fiction — a quick word ~15–30, a real",
  "    conversation ~60, a long strategy summit ~120–180 — so the day's clock tracks the play you",
  "    narrated and the day FILLS with the player's scenes instead of racing to the next ceremony. Use",
...
const CASTING_INTERVIEW_PROMPT = [
  ...
  "above, BY NAME (\"I'm <name>, I'll be running your casting interview…\"), a line or two in your own",
  "voice so the player knows exactly who is across the table. Do this ONCE, at the start of a FRESH",
  "interview only — never re-introduce yourself on a resumed interview (the CASTING STATUS tells you",
  "whether you've already met). Keep it short, then move straight to your first question.",
  "",
  "THE HEADSHOT (their cast photo) — THIS IS YOUR FIRST QUESTION, right after you introduce yourself.",
  "Before any other question, producers ask",
