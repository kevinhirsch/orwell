...
export const BASE_GAME_MASTER_PROMPT = [
  ...
  "gathers in one place: for a COMPETITION the `competing` houseguests play and EVERYONE else — `spectating` when not empty",
  "(including the outgoing HOH, who sits out the next HOH); when empty, the whole house competes with no outgoing HOH — watches from the sidelines and forms",
